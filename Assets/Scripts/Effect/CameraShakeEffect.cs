...
public class CameraShakeEffect : MonoBehaviour
{
    ...
    // 震动时间
    public float setShakeTime = 3.0f;
    // 震动的FPS
    ...
    public void shake(float shakeLevel, float setShakeTime, float shakeFps, bool isShake)
    {
        this.shakeLevel = shakeLevel;
        this.setShakeTime = setShakeTime;
        this.shakeFps = shakeFps;
        this.isshakeCamera = isShake;
    }
}
